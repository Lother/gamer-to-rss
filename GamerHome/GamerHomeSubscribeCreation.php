 ...
 * 巴哈小屋轉換 RSS
 */
class GamerHomeSubscribeCreation extends GamerHome{
	protected $_creation_url = 'http://home.gamer.com.tw/subscribe_creation.php?type=subscribe&owner=';
	protected $_title = ' 的訂閱聯播 RSS';
	protected $_find_page = '訂閱聯播';
